...
<head>
    ...
    <script>
        ...
        function chakan(id) {
            ...
            $.post("${pageContext.request.contextPath}/loos/query", {
        ...
        function xxiu() {
            ...
            var nahui = $("#nahui").val();
            var state = 1;
            $.post('${pageContext.request.contextPath}/loos/quhui', {
                'loosId': id,
                "loosStatus": state,
                "receiveName": dname,
                'receivePhone': dphone,
        ...
        function save() {
            ...
            var img = "1";
            $("#myModal").modal("hide");
            $.post('${pageContext.request.contextPath}/loos/add', {
                'loosName': name,
                "loosImages": img,
                'loosAddress': address,
                'loosjdate': time,
...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-inline">
            ...
            <button type="button" class="btn btn-default" onclick="loos()" style="float: right; margin-top: 20px"
                    data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"></span>添加拾取物详情
            </button>
        </form>
    </div>
</div>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="date" style="margin-top: 10px" class="form-control" id="time"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="jname"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="jphone"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <table id="sw" style="width: 90%;margin: 0px auto">
                    <tr style="width: 100%;height: 80px">
                        <td style="width: 300px;height: 35px;">拾取物名称：<input style="width: 140px;"
                                                                                 class="form-control" type="text"
                                                                                 id="swmc" readonly></td>
                        <td style="width:300px;height: 35px;">拾取人姓名：<input style="width: 140px;"
                                                                                class="form-control" type="text"
                                                                                id="srxm" readonly></td>
                        <td style="width:300px;height: 35px;">拾取人电话：<input style="width: 140px;"
                                                                                class="form-control" type="text"
                                                                                id="srdh" readonly></td>
                        <td style="width:300px;height: 35px;">捡到时间：<input style="width: 140px;" class="form-control"
                                                                              type="text" id="jtime" readonly></td>
                    </tr>
                    <tr style="width: 100%;height: 80px">
                        <td style="width: 300px;height: 35px;">拾取物地点：<input style="width: 140px;"
                                                                                 class="form-control" type="text"
                                                                                 id="swdd" readonly></td>
                        <td style="width: 300px;height: 35px;">领走人姓名：<input style="width: 140px;"
                                                                                 class="form-control" type="text"
                                                                                 id="dsxm" readonly></td>
                        <td style="width: 300px;height: 35px;">领走人电话：<input style="width: 140px;"
                                                                                 class="form-control" type="text"
                                                                                 id="dsdh" readonly></td>
                        <td style="width:300px;height: 35px;">领取时间：<input style="width: 140px;" class="form-control"
                                                                              type="text" id="qtime" readonly></td>
                    </tr>
                </table>
                &nbsp;
                <div class="modal-footer">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="dname"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="dphone"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="date" style="margin-top: 10px" class="form-control" id="nahui"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
