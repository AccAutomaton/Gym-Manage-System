...
<head>
    ...
    <script>
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $.post('${pageContext.request.contextPath}/goods/del', {
                            'goodsId': id,
        ...
        function search() {
            var opt = $('#table').bootstrapTable('getOptions');
            var goodsid = $('#goodsid').val();
            $.post("${pageContext.request.contextPath}/goods/query", {
                "pageSize": opt.pageSize,
                "pageNumber": opt.pageNumber,
                "goodsname": goodsid
            }, function (releset) {
        ...
        function save() {
            ...
            $.post("${pageContext.request.contextPath}/goods/count", {"goodsName": name}, function (releset) {
                $("#table").bootstrapTable('load', releset);
                if (releset < 1) {
                    $.post('${pageContext.request.contextPath}/goods/add', {
                        'goodsName': name,
                        'unit': unit,
                        'unitPrice': unitprice,
                        'sellPrice': sellprice,
        ...
        function update() {
            ...
            var count = $('#spsl').val();
            $("#myModal3").modal("hide");
            $.post('${pageContext.request.contextPath}/goods/update', {
                'goodsId': id,
                'goodsName': name,
                "unit": unit,
                "unitPrice": unitprice,
        ...
        function upd2() {
            ...
            if (inventory < jinhuo) {
                ...
                $.post('${pageContext.request.contextPath}/goods/upd', {
                    'goodsId': id,
                    "inventory": ss
                }, function (data) {
                    $.post("${pageContext.request.contextPath}/goods/query", {
...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-inline">
            ...
            <button type="button" class="btn btn-default" onclick="ss()" style="float: right; margin-top: 20px"
                    data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"></span>商品进货
            </button>
        </form>
    </div>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="unitprice"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="sellprice"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="count"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="remark"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                ...
                <form>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" style="margin-top: 10px" class="form-control" readonly id="mc"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" style="margin-top: 10px" class="form-control" id="jj"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="sellprice" class="col-sm-4 control-label" style="margin-top: 10px">商品售价</label>
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="sj"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="count" class="col-sm-4 control-label" style="margin-top: 10px">商品数量</label>
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="spsl"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="remark" class="col-sm-4 control-label" style="margin-top: 10px">备注</label>
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="bz"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" readonly id="xgname"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" readonly id="xgcount"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="jinhuo" id="th" class="col-sm-4 control-label"
                               style="margin-top: 10px">退货数量</label>
                        <div class="col-sm-8">
                            <input type="text" style="margin-top: 10px" class="form-control" id="jinhuo"
                                   parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                   parsley-type="email" parsley-validation-minlength="1">
                        </div>
                    </div>
