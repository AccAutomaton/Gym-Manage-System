...
<head>
    ...
    <script>
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $.post('${pageContext.request.contextPath}/goodinfo/del', {
                            'id': id,
        ...
        function search() {
            ...
            const goodsid = $('#goodsid').val();
            const memberid = $('#memberid').val();
            $.post("${pageContext.request.contextPath}/goodinfo/query", {
                "pageSize": opt.pageSize,
                "pageNumber": opt.pageNumber,
                "goodsid": goodsid,
                "memberid": memberid
        ...
        function ss() {
            ...
            $.post("${pageContext.request.contextPath}/goods/topcoach", {}, function (releset) {
                ...
                let tt = "";
                let tttt = "";
                const ttt = "<option value='-1'>" + "--请选择--" + "</option>";
        ...
        function save() {
            ...
            $.post('${pageContext.request.contextPath}/goods/cha', {'goodsId': spid}, function (data) {
                ...
                if (data.inventory > count) {
                    $.post('${pageContext.request.contextPath}/goodinfo/add', {
                        'member.memberId': hyid,
                        'goods.goodsId': spid,
                        'count': count,
                        'price': j,
                        'remark': remark
                        ...
                        $.post('${pageContext.request.contextPath}/goodinfo/chamember', {'memberId': hyid}, function (data) {
                            const money = data.memberbalance;
                            const qian = parseInt(money - j);
                            $.post('${pageContext.request.contextPath}/goodinfo/updmember', {
                                'memberId': hyid,
                                'memberbalance': qian
                            }, function (data) {
                            });
                        ...
                        $.post('${pageContext.request.contextPath}/goods/cha', {'goodsId': spid}, function (data) {
                            ...
                            const shu = parseInt(inventory - count);
                            $.post('${pageContext.request.contextPath}/goodinfo/updgoods', {
                                'goodsId': spid,
                                'inventory': shu
                            }, function (data) {
                            });
        ...
        function dels() {
            const opt1 = $("#table").bootstrapTable('getSelections');
            const opt = $("#table").bootstrapTable('getOptions');
            const goodsid = $('#goodsid').val();
            const memberid = $('#memberid').val();
            const array = [];
...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-inline">
            ...
            <button type="button" onclick="ss()" class="btn btn-default" style="float: right; margin-right: 20px"
                    data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"></span>添加消费记录
            </button>
                    ...
                    <div style="width: 90%;margin: 0 auto">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <input type="text" style="width: 470px;margin-top: 10px" class="form-control" readonly
                                       id="hyid" parsley-trigger="change" parsley-required="true" parsley-minlength="4"
                                       parsley-type="email" parsley-validation-minlength="1">
                            </div>
                            <a title='查询' onclick="kan1()" href="#"
                               style="float: right;margin-top: -25px;margin-right: -10px;transform: scale(1.5);width:25px;height:25px;"
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <%--suppress HtmlUnknownAttribute --%>
                                <input type="text" style="width: 470px;margin-top: 10px" class="form-control" id="count"
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <%--suppress HtmlUnknownAttribute --%>
                                <input type="text" style="width: 470px;margin-top: 10px" class="form-control"
                                       id="remark" parsley-trigger="change" parsley-required="true"
                                       parsley-minlength="4" parsley-type="email" parsley-validation-minlength="1">
                            </div>
                        </div>
                        &nbsp;
                    </div>
