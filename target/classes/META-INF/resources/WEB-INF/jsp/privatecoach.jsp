...
<head>
    ...
    <script>
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $.post('${pageContext.request.contextPath}/privateinfo/del', {
                            'id': id,
        ...
        function search() {
            ...
            var subjectid = $('#subjectid').val();
            var memberid = $('#memberid').val();
            $.post("${pageContext.request.contextPath}/privateinfo/query", {
                "pageSize": opt.pageSize,
                "pageNumber": opt.pageNumber,
                "coachid": coachid,
                "subjectid": subjectid,
        ...
        function save() {
            ...
            $.post('${pageContext.request.contextPath}/coach/cha', {'id': jlid}, function (data) {
                ...
                if (data.coachStatic == 0) {
                    $.post('${pageContext.request.contextPath}/private/add', {
        ...
        function upd1() {
            ...
            $("#myModal2").modal("hide");
            $.post('${pageContext.request.contextPath}/privateinfo/upd', {
                'pid': id,
                ...
                <form>
                    ...
                    <table style="margin-top:10px;border:1px solid #ccc;padding:20px;margin-bottom:20px;">
                        <tr style="margin: 20px; margin-left: 20px;padding: 20px;">
                            <td style="width:450px;padding-left: 20px"><label
                                    style="float: left;margin-top: 10px">教练姓名：</label>
                                <select id="coach" style="margin-top: 10px"
                                        class="form-control">
                        ...
                        <tr style="margin: 20px; margin-left: 20px;padding: 20px;">
                            <td colspan="2" style="width:900px;padding-left: 20px"><input type="text"
                                    ...
                                    style="float: right;margin-top: 10px">实收钱：</label>
                        ...
                        <tr style="margin: 20px; margin-left: 20px;padding: 20px;margin-bottom: 30px">
                            <td colspan="2" style="width:900px;padding-left: 20px"><input type="text"
                                                                                          style="float:right;margin-top: 10px;margin-right:30px;width: 100px"
                                                                                          id="zl" class="form-control"
                                                                                          readonly="readonly"><label
                                    style="float: right;margin-top: 10px">找零：</label>
                            </td>
                        </tr>
